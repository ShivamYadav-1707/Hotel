...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference("Visitor.count") do
      post visitors_url, params: { visitor: { date_of_arrival: @visitor.date_of_arrival, datetime: @visitor.datetime, description: @visitor.description, name: @visitor.name, room_no: @visitor.room_no } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { date_of_arrival: @visitor.date_of_arrival, datetime: @visitor.datetime, description: @visitor.description, name: @visitor.name, room_no: @visitor.room_no } }
